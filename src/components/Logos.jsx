...
export default function Logos() {
  return (
    <div className="w-full h-auto px-[0.6rem]">
      <div className="max-w-full h-auto bg-black grid grid-cols-1 container rounded-2xl py-8 md:py-16 md:px-[8rem] px-[0.2rem] hover:bg-green-500 duration-1000 hover:shadow-2xl">
